...
"background-color:#CCFFCC")
        ...
        self.head_2.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/pictures/staff3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius:5px")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/pictures/search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.modifyvalue.setGeometry(QtCore.QRect(435, 160, 111, 21))
...
"background-color:#CCFFCC")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:/pictures/search1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/pictures/insert.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/pictures/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        item.setFont(font)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/pictures/staff5.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon5)
        ...
        item.setFont(font)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/pictures/staff2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon6)
        self.listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        font = QtGui.QFont()
        ...
        item.setFont(font)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("C:/pictures/staff4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        font = QtGui.QFont()
...
"border-radius:5px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_74.setText(_translate("MainWindow", "输入修改值："))
